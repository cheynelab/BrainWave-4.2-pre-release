...
function bw_plot_tfr(TFR_ARRAY, plotTimeCourse, groupLabel, filename)
    ...
    fh = figure('Position',[scrnsizes(1,3)/3+200 scrnsizes(1,4)/2 800 600],'color','white', 'NumberTitle','off');
    if ispc
        movegui(fh,'center');
    end
    ...
    uicontrol('style','pushbutton','units','normalized','fontsize',12,'position',...
        [0.89 0.03 0.1 0.03],'string','Set Scale','callback',@setScale_callback);
