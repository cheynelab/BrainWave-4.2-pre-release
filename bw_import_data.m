...
function [badTrialCount, badChannelCount, badChannelList] = headMotionPlot_scanTrials
    ...
    for k=1:numDatasets
        ...
        if plotAll == 1
            ...
            % bug fix in version 4.2 - don't reload if epoching only one dataset
            % that is being edited / epoched (*** otherwise this will undo edits to latency list etc *** ) 
            if numDatasets > 1
        ...
        headMotionArray(k,1:size(headMotionList,2)) = headMotionList;
