...
uicontrol('style','text','fontsize',14,'units','normalized','horizontalalignment','left','position',...
     [0.27 0.96 0.08 0.03],'string','Marker:','BackgroundColor','white','foregroundcolor','black');
marker_Popup =uicontrol('style','popup','units','normalized','fontsize',12,'position',[0.32 0.9 0.12 0.09],...
...
cursor_text = uicontrol('style','text','fontsize',12,'units','normalized','position',[0.76 0.49 0.2 0.03],...
...
uicontrol('style','text','fontsize',11,'units','normalized','position',...
     [0.08 0.305 0.1 0.025],'string','Plot Settings','BackgroundColor','white','foregroundcolor','blue','fontweight','b');
...
uicontrol('style','pushbutton','units','normalized','fontsize',11,'position',[0.45 0.35 0.1 0.05],...
