...
//
// calling syntax is:
// [timeVec channelNames data] = bw_CTFGetAverage( filename, hipass, lowpass );
//
// returns
...
//			    2.6  - May, 2020 - removed filtering as it was not used
// ************************************
...
//	}
	...
	// read average - gradient = -1 sensorsOnly = true
	if ( !readMEGDataAverage( dsName, dsParams, aveTrialData, -1, true) )
	{
